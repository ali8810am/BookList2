        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateMembered = table.Column<DateTime>(type: "datetime2", nullable: false),
                    MembershipRate = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestingCustomerId = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BorrowAllocations", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BorrowAllocations_BookId",
                table: "BorrowAllocations",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_BorrowAllocations_CustomerId",
                table: "BorrowAllocations",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_BorrowAllocations_EmployeeId",
                table: "BorrowAllocations",
                column: "EmployeeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BorrowRequests_CustomerId",
                table: "BorrowRequests",
                column: "CustomerId");
